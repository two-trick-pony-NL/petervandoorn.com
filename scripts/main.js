...
async function getInputValue(){
  ...
  if(value.toLowerCase() === "help"){
  ...
  else if(value.toLowerCase() === "projects" || value.toLowerCase() === "project") {
    trueValue(value);
    createText('<a href="https://calendly.com/petervandoorn/meetup" class="meetbutton">Book a chat, to discuss your project 💬</a>')
    ...
    createText('<a href="https://calendly.com/petervandoorn/meetup" class="meetbutton">Let\'s talk a about your project 💬</a>')
    ...
    createCode(
      ...
      "  <img src=\"images/avatar.jpeg\" width=\"200\" height=\"200\" alt=\"Peter\" style=\"border-radius: 50%;\">",
      "  <a href='https://calendly.com/petervandoorn/meetup' class='meetbutton'>Book a chat, to discuss your project 💬</a>",
      "</div>"
    );
    ...
    createText('<a href="https://calendly.com/petervandoorn/meetup" class="meetbutton">Schedule chat 💬</a>')
