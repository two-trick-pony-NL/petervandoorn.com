...
async function getInputValue(){
  ...
  if(value.toLowerCase() === "help"){
    ...
    createCode("<hr><br>ScanGame", "<br>Scangame is a fun game I designed and built. You earn points by finding and photographing objects in your house. For instance: Scan a person, or a plant. Objects are detected with AI and analyzed on a custom backend. The game itself runs natively on your smartphone. Check it out: <a href='https://github.com/two-trick-pony-NL/ScanGameApps'>here</a><br><br> #Heroku #FastAPI #Python #ReactNative #AI #MachineLearning");
